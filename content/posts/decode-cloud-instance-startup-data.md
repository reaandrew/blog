...
Finally cloud-init supports gzipped user data which is then base64 encoded, more details about this can be found here [https://cloudinit.readthedocs.io/en/latest/explanation/format.html](https://cloudinit.readthedocs.io/en/latest/explanation/format.html).  The resulting output is then:
